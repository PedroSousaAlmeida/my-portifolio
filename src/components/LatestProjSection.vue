<template>
    ...
    <section class="text-center py-16" data-aos="fade-in">
        <div class="relative w-full max-w-md mx-auto">
            <img src="@/assets/commingsoon.webp" alt="Developer Coding Coming Soon"
                class="rounded-xl shadow-lg opacity-90 hover:opacity-100 transition duration-500">
            <div class="absolute inset-0 bg-gradient-to-r from-primary to-secondary opacity-40 rounded-xl"></div>
        </div>
        <h2 class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary mt-8">
            Coming Soon!
        </h2>
