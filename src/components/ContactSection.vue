<template>
  <section class="text-white mt-20 py-16 relative overflow-hidden" id="contact">
    <!-- Background Glow -->
    <div class="absolute z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-primary/10 via-pink-500/10 to-purple-500/10 blur-3xl"></div>
      ...
      <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div data-aos="fade-right">
          ...
          <div class="space-y-4">
            ...
            <div class="group" data-aos="fade-up" data-aos-delay="100">
              <div class="flex items-center gap-4 p-4 rounded-2xl bg-[#111a3e]/50 backdrop-blur-sm
        ...
        <div data-aos="fade-left">
          <form @submit.prevent="sendEmail"
                class="p-8 rounded-2xl bg-[#111a3e]/50 backdrop-blur-sm border border-[#1f1641]
                       shadow-2xl hover:border-primary/30 transition-all duration-500">

            <!-- Success Message -->
            <div v-if="formStatus === 'success'"
                 class="mb-6 p-4 rounded-xl bg-green-500/10 border border-green-500/50 flex items-center gap-3">
            ...
            <div v-if="formStatus === 'error'"
                 class="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/50 flex items-center gap-3">
            ...
            <div class="mb-6">
              ...
              <input
                ...
                class="w-full px-4 py-3 bg-[#111827] border border-[#1f1641] rounded-xl
            ...
            <button
              type="submit"
              :disabled="formStatus === 'sending'"
              class="w-full px-6 py-3 bg-gradient-to-r from-primary to-pink-500 rounded-xl
